...
// 자유게시판 수정 서블릿
@WebServlet("/FreeNoticeBoard_Update")
public class FreeBoard_Update_Servlet extends HttpServlet{	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("자유게시판 <글 수정> 서블릿 동작");
		...
		try {
	    	...
	    	if(freeBoardDao.freeBoardUpdate(freeboard) != 0){
